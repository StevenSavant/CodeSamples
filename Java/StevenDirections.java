/**
   ...
   AUTHOR   : Steven Burell
	...
	COURSE	: 	CSCI 2073
 	DATE   	: 	4/7/2016
 	PURPOSE	: 	This Directions Class uses Stack Data Structures to analyze directional input
...
public class StevenDirections
{
   private double total;
   private Stack<StevenDirection> directionList;
   private Stack<StevenDirection> temp;
   private File inFile;
   private Scanner file;
   Stack<StevenDirection> tempStack = new Stack<StevenDirection>();
   
   /**
      Contstructor for Directions Object, takes no arguments. It initialzes two private global Stacks.
   */
   public StevenDirections()
   {
      directionList = new Stack<StevenDirection>();
      tempStack = new Stack<StevenDirection>();
   }
   ...
   */
   public double returnTrip(double maxDistance)
   {
      total = 0;
      tempStack.push(directionList.pop());
      StevenDirection p = tempStack.peek();
      boolean search = true;
   ...
   */
   private void loadDirections()
   {
      ...
      while (file.hasNext())
      {
         ...
         dir = new StevenDirection(distance, direct, street);
